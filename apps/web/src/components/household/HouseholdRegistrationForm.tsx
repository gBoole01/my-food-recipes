...
import { PantryStapleToggleGrid } from "./PantryStapleToggleGrid";
...
export function HouseholdRegistrationForm({
  ...
  const togglePantryStaple = (name: string) =>
    setPantryStaples((prev) => (prev.includes(name) ? prev.filter((v) => v !== name) : [...prev, name]));
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <Card className="p-4">
        ...
        <PantryStapleToggleGrid selected={pantryStaples} onToggle={togglePantryStaple} />
      </Card>
